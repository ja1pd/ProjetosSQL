...
-- Questao_01_A
create or replace view Questao_01_A as
select 
...
-- Questao_01_B
create or replace view Questao_01_B as
select 
store_id as loja, 
...
-- Questao_01_C
create or replace view Questao_01_C_Produtos as
select 
...
create or replace view Questao_01_C_Clientes as
select 
...
create or replace view Questao_01_C_Vendedores as
select 
...
create or replace view Questao_01_C as
select * from Questao_01_C_Produtos
union
select * from Questao_01_C_Clientes
union
select * from Questao_01_C_Vendedores;